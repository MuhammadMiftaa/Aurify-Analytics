...
export const investmentBuySchema = z.object({
  ...
  assetCode: z.object({
    ...
    name: z.string(),
    unit: z.string(),
    toUSD: z.coerce.number(),
    toEUR: z.coerce.number(),
    toIDR: z.coerce.number(),
...
export const investmentSellItemSchema = z.object({
  ...
  assetCode: z.object({
    ...
    name: z.string(),
    unit: z.string(),
    toUSD: z.coerce.number().nullable(),
    toEUR: z.coerce.number().nullable(),
    toIDR: z.coerce.number().nullable(),
    createdAt: z.coerce.date(),
    updatedAt: z.coerce.date(),
  }),
  createdAt: z.coerce.date().optional(),
